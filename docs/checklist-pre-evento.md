...
| #    | decisão                                                                                                                                                                                                                   | prazo              |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| 3.13 | **Calibrar o limite de taxa.** T18 mediu: 200 cadastros do mesmo IP viraram 30 aceitos e **170 recusados**. Proposta com a conta em `relatorio-carga.md` §4                                                               | antes de publicar  |
...
| R-2 | **O limite de taxa recusaria a fila** se ninguém decidir 3.13                                                 | `RATE_LIMIT_ATIVO=false` derruba o limite sem publicar código (`plano-do-dia.md` §3)            | ______     |
